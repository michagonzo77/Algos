    ...
    insertRecursive(newVal, curr = this.root) {
        ...
        if (newVal <= curr.data) {
            if (curr.left == null) {
                let newNode = new BSTNode(newVal);
                curr.left = newNode;
            } else this.insertRecursive(newVal, curr.left)
        } else {
            if (curr.right == null) {
                let newNode = new BSTNode(newVal);
                curr.right = newNode;
            } else this.insertRecursive(newVal, curr.right)
        }
    }
...
oneNodeTree.insertRecursive(4);
oneNodeTree.insertRecursive(7);
twoLevelTree.insertRecursive(4);
