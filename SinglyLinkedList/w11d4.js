...
class SinglyLinkedList {
    ...
    */
    secondToLast() {
        ...
        const secondToLastData = runner.data;
        return secondToLastData;
    }
...
console.log(emptyList.prepend(3,1));
console.log(singleNodeList.prepend(3,1));
console.log(firstThreeList.prepend(6,2));
